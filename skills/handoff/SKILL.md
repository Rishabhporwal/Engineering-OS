...
3. Read [`docs/quality-gates.md`](../../docs/quality-gates.md) — what gates would the normal path have checked? Surface any that would be skipped.
...
8. Print: old stage → new stage; gates skipped (if any); the new owner; reminder: "VETO authority of subsequent agents still applies."
