...
## Storage layers (per Brain mobile architecture, canon/technical-requirements.md)
...
|---|---|---|
| Mobile app offline UX | **Karan** | canon/technical-requirements.md (offline-first) |
| Server-side idempotency for queued mutations | **Vikram** | `idempotency-handling` |
| Decision Log conflict semantics | **Aryan** + **Vikram** | canon/technical-requirements.md (Decision Log discipline) |
