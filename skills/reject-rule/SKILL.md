---
name: reject-rule
description: Stakeholder-only — reject a proposed rule. Marks the proposal as rejected with a written reason; does NOT delete the proposal (audit trail).
disable-model-invocation: true
---

Reject a previously-proposed rule.

**Stakeholder-only.** Same actor check as `/engineering-os:adopt-rule`.
...
5. **Remove from pending-stakeholder-attention.** Strike through the line.
