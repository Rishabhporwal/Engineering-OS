...
> **Building a feature?** Use `canon/INDEX.md` as the targeted index — topic → owner file → the one `canon/TECH/NN §` your task needs. Never load canon whole (that was the single largest avoidable cost). The canon wins on any conflict; cite, don't restate.
> Updated 2026-05-23.
